...
import { useTrackedWallets } from '../hooks/useTrackedAssets'
...
const TrackedWalletsModal = ({ onClose }: Props) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
            <div className="bg-zinc-900 rounded-lg shadow-xl w-full max-w-lg p-6 relative border border-zinc-700">
                ...
                <h2 className="text-white text-lg font-semibold mb-4">Tracked Wallets</h2>

                {trackedWallets.length === 0 ? (
                    <p className="text-gray-400 text-sm">No wallets tracked yet.</p>
                ) : (
...
export default TrackedWalletsModal
